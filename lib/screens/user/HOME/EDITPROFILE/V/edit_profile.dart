...
import 'package:inkozi/screens/USER/HOME/EDITPROFILE/C/controller.dart';
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        body: GetBuilder<EditProfileController>(initState: (state) {
          Get.put(EditProfileController());
          EditProfileController.to.firstNameController.text =
              StaticValues.userInfo!.firstName!;
          EditProfileController.to.lastNameController.text =
              StaticValues.userInfo!.lastName!;
        }, builder: (obj) {
